...
def main():
    ...
    train_root = './media/train_op/video_image_15/'  ### traffic_frames root
    ...
    train_imgs = sorted(listdir('./media/train_op/mask_15'))	
    #print(train_imgs)
    valid_imgs = sorted(listdir('./media/valid/mask_15'))
    ...
    valid_loader = DataLoader(
            ImageList(valid_root, valid_imgs,for_valid=True),
    ...
    model.load_state_dict(checkpoint['state_dict'])
    #best = torch.load  = torch.load('./ckpts/best.tar')
