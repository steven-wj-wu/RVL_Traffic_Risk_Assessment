...
def parse_opts():
    ...
    parser.add_argument(
        '--assess_rgb_path',
        default='./best_rgb.pth',
        type=str,
        help='path to assessment model weight')

    parser.add_argument(
        '--assess_flow_path',
        default='./best_flow.pth',
        type=str,
        help='path to assessment model weight')

    parser.add_argument(
        '--attention_path',
        default='./saliency/op.tar',
        type=str,
        help='path to attention model weight')

    parser.add_argument(
        '--use_cbam',
        action='store_true',
        help='If true, use cbam resnet.')

    parser.add_argument(
        '--assess_input',
        default='sliding_window',
        type=str,
        help='sliding_window for assessment in every timestamp sequence for assessment in each 19 frame')

    parser.add_argument(
        '--assess_length',
        default= 19,
        type=int,
        help='assessment input length. 9 or 19')
